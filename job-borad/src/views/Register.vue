<template>
  <div
    class="container-fluid min-vh-100 p-2 d-flex flex-wrap"
    style="color: #1c2ca4"
  >
    <!-- Left section -->
    <div
      class="col-12 col-md-6 d-flex align-items-center justify-content-center bg-white p-4"
    >
      <div class="w-100 form-container">
        <h2 class="mb-3 fw-bold">Create account.</h2>
        <p>
          Already have account?
          <router-link to="/employeer/login" class="text-primary"
            >Log In</router-link
          >
        </p>
        ...
        <div class="text-center mb-3 bg-light text-secondary p-2 rounded">
          <p class="mb-2 fw-semibold text-uppercase small">
            Create account as a
          </p>
          <div class="d-flex justify-content-center">
            <div class="btn-group" role="group">
              <button
                ...
                class="btn"
                :class="{
                  'btn-primary text-white': accountType === 'candidate',
                  'btn-light text-secondary': accountType !== 'candidate',
                }"
              ...
              <button
                ...
                class="btn"
                :class="{
                  'btn-primary text-white': accountType === 'employer',
                  'btn-light text-secondary': accountType !== 'employer',
                }"
        ...
        >
          <div class="mb-3 row">
            <div class="mb-3">
              <input
                ...
                required
                :class="{ 'is-invalid': wasValidated && !fullName }"
              />
          ...
          <div class="form-check mb-3">
            <input
              ...
              id="terms"
              required
              :class="{ 'is-invalid': wasValidated && !termsAccepted }"
            />
        ...
        <div class="d-flex justify-content-center gap-2">
          <button
            class="btn btn-outline-primary flex-fill social-btn"
  ...
  methods: {
    ...
    async handleRegister() {
      ...
      try {
        ...
        this.errorMessage =
          "This Email already in use. Please try again later.";
      }
    },
  },
};
